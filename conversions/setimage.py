...
def setImage(request):
	...
	book.imageSmall = fromSearchResults.imageSmall
	book.put()
	
	return createResponse(book)

def createErrorResponse(msg):
	return render_to_response('conversionBookImage.html', {"error" : msg})
...
def createResponse(book, errorMsg = None, interval = 2):
	...
	return render_to_response('conversionBookImage.html', response)	