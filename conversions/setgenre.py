...
def setGenre(request):
	...
	book.tags = fromSearchResults.genre
	book.put()
	
	return createResponse(book)

def createErrorResponse(msg):
	return render_to_response('conversionBookGenre.html', {"error" : msg})
...
def createResponse(book, errorMsg = None, interval = 2):
	...
	return render_to_response('conversionBookGenre.html', response)	